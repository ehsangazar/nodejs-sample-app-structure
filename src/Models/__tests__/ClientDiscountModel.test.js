...
describe('ClientDiscount', () => {
  ...
  it('should work fine', () => {
    ...
    DiscountObject.create({
      name: 'DefaultDiscount', type: 'more', adsName: 'classic', bought: 2, willget: 3,
    });
  ...
  it('should not work because it is repeated', () => {
    ...
    const DiscountObject = new DiscountModel();
    DiscountObject.create({
      name: 'DiscountRepeated', type: 'more', adsName: 'classic', bought: 2, willget: 3,
    });
