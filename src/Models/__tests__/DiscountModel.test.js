...
describe('DiscountModel', () => {
  ...
  it('should not work because data for type more is not enough', () => {
    ...
    const res = DiscountObject.create({
      name: 'MoreIsNotEnough', type: 'more', adsName: 'classic', willget: 3,
    });
    expect(res.status).to.equal('error');
    expect(res.error).to.equal('data is not valid');
  });
  it('should work because data is enough for reduce', () => {
    ...
    const DiscountObject = new DiscountModel();
    const res = DiscountObject.create({
      name: 'ReduceIsEnough', type: 'reduce', adsName: 'classic', newPrice: 10000,
    });
  ...
  it('should work because data is enough for more', () => {
    ...
    const DiscountObject = new DiscountModel();
    const res = DiscountObject.create({
      name: 'MoreIsEnough', type: 'more', adsName: 'classic', bought: 2, willget: 3,
    });
    expect(res.status).to.equal('ok');
  });
  it('should get an error to create a repeated Entry', () => {
    ...
    DiscountObject.create({
      name: 'RepeatedTesting', type: 'more', adsName: 'classic', bought: 2, willget: 3,
    });
    const resSecond = DiscountObject.create({
      name: 'RepeatedTesting', type: 'more', adsName: 'classic', bought: 2, willget: 3,
    });
  ...
  it('should get an error if type is not valid', () => {
    ...
    const DiscountObject = new DiscountModel();
    const res = DiscountObject.create({
      name: 'TypeNotValid', type: 'less', adsName: 'classic', bought: 2, willget: 3,
    });
    expect(res.status).to.equal('error');
  ...
  it('should get an error if adsname is not valid', () => {
    ...
    const DiscountObject = new DiscountModel();
    const res = DiscountObject.create({
      name: 'AdsNameNotValid', type: 'more', adsName: 'classicThatDoesntExist', bought: 2, willget: 3,
    });
    expect(res.status).to.equal('error');
  ...
  it('should get an error if bought is not valid', () => {
    ...
    const DiscountObject = new DiscountModel();
    const res = DiscountObject.create({
      name: 'boughtNotValid', type: 'more', adsName: 'classic', bought: 'S', willget: 3,
    });
    expect(res.status).to.equal('error');
  ...
  it('should get an error if willget is not valid', () => {
    ...
    const DiscountObject = new DiscountModel();
    const res = DiscountObject.create({
      name: 'WillgetNotValid', type: 'more', adsName: 'classic', bought: 2, willget: 'S',
    });
    expect(res.status).to.equal('error');
  ...
  it('should get an error if willget is not bigger than bought', () => {
    ...
    const DiscountObject = new DiscountModel();
    const res = DiscountObject.create({
      name: 'willGetBigger', type: 'more', adsName: 'classic', bought: 2, willget: 1,
    });
    expect(res.status).to.equal('error');
